...
Original file is located at
    https://colab.research.google.com/drive/1l6dGTGVVKqNktBp1WjLDYhOg8gGXrca1
"""
...
print("Total number of days present in dataset: ",df.shape[0])  #df.shape[0] accesses the first element of the tuple, which is the number of rows in the DataFrame.
print("Total number of fields present in dataset:",df.shape[1]) #df.shape[1] accesses the second element of the tuple returned by df.shape, which is the number of columns in the DataFrame.
...
# printing start date and end date of dataset
